...
# Base da URL para ITR
base_url = "https://dados.cvm.gov.br/dados/CIA_ABERTA/DOC/ITR/DADOS/itr_cia_aberta_{}.zip"

# Dicionário para armazenar os DataFrames ITR pivotados
dfs_itr_pivot = {}
...
for ano in anos:
    ...
    if r.status_code == 200:
        pasta_destino = f"./dados_cvm_itr/{ano}"
        ...
        # Procurar apenas o arquivo DFC trimestral dentro do ZIP
        for nome_arquivo in z.namelist():
            if nome_arquivo.startswith("itr_cia_aberta_DFC_MI_con_") and nome_arquivo.endswith(".csv"):
...
output_path = r"C:\Users\econo\Downloads\DFC_ITR_2023_2025.xlsx"

with pd.ExcelWriter(output_path, engine="openpyxl") as writer:
    for ano, df in dfs_itr_pivot.items():
